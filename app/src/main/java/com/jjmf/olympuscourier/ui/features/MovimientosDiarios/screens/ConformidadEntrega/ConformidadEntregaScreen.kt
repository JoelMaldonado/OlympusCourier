...
import com.jjmf.olympuscourier.util.*
        ...
        Column(
            ...
            CajaTexto(
                ...
                trailingIcon = {
                    ...
                    } else if (viewModel.documento.length >= 8) {
                        Icon(
                ...
                Button(
                    onClick = {
                        ...
                        if (viewModel.costo.isNumeric()) {
                            if (viewModel.costo.toDouble() > 1) viewModel.insert(context = context)
